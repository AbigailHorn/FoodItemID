function [thisSimSig, SimSig_R_norm, MC_ratio_actual] = SimSig_L3_OB_WHS4_norm(net_i, MC_method, food_net, stage_ends, prior_pmf, contam_rets_actual, num_samples, ill_interval)
