...
function [MC_ratio_PUB, SimSig_ratio, MC_ratio_actual] = SimSig_L3_OB_WHS4(MC_method, food_net, stage_ends, prior_pmf, contam_rets_actual, num_samples, ill_interval)
