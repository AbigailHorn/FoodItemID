...
function [nested_ob_data, net_MC_means, net_MC_CI95] = SimSig_L2_RLG(all_food_nets, all_net_names, init_vals, stage_ends, all_ob_data, all_ob_names, ill_over_time_interval, MC_method, num_samples, dpr_flag, save_plot)
    ...
    for method_i = method_index
        ...
        for net_i = net_index %num_food_nets
            ...
            if dpr_flag == 0
                ...
                [MC_ratio_PUB, MC_ratio_actual] = SimSig_L3_OB_RLG(method_i, food_net, stage_ends, prior_pmf, contam_rets_actual, num_samples, ill_over_time_interval);
                ...
                [MC_ratio_PUB, MC_ratio_actual] = SimSig_L3_DPR_RLG(method_i, food_net, stage_ends, prior_pmf, contam_rets_actual, num_samples, ill_over_time_interval);
            ...
            %% 95% CI MC_ratio
            y = MC_ratio_PUB.'; %randn(50,100);                                  % Create Dependent Variable ?Experiments? Data
        ...
        plot_MC_CI95_PUB_actual(ob_name, all_net_names, method_i, num_samples, net_MC_means_PUB, net_MC_CI95_PUB, net_MC_means_actual, net_MC_CI95_actual, ill_over_time_interval, dpr_flag, save_plot)
