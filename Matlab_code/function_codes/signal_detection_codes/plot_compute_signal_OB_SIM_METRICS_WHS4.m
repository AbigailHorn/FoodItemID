function [net_SimSig_means, net_raw_means] = plot_compute_signal_OB_SIM_METRICS_WHS4(all_food_nets, init_vals, stage_ends, current_ob_data, ill_over_time_interval, method_i, num_samples, dpr_flag)
    ...
    net_index = 1:num_food_nets;
        ...
        for net_i = net_index %num_food_nets
            ...
            if dpr_flag == 0
                ...
                %[~, MC_SimSig, MC_raw] = MC_compute_PracticalUB_RLG(method_i, food_net, stage_ends, prior_pmf, current_ob_data, num_samples, ill_over_time_interval);
                [~, MC_SimSig, MC_raw] = SimSig_L3_OB_WHS4(net_i, method_i, food_net, stage_ends, prior_pmf, current_ob_data, num_samples, ill_over_time_interval);
