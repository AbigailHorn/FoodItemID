...
for ob_i = 1:(N*num_ob)
    ...
    [method0_Sig, method0_raw] = plot_compute_signal_OB_SIM_METRICS_WHS4(all_food_nets, 0, stage_ends, current_ob_data, ill_over_time_interval, MC_method, num_samples, 0);
    [method1_Sig, method1_raw] = plot_compute_signal_OB_SIM_METRICS_WHS4(all_food_nets, 0, stage_ends, current_ob_data, ill_over_time_interval, MC_method, num_samples, 1);
...
% method0_Sig
net1_net1_WHS4_MC1_mean_ACC_1_method0_Sig = mean(ACC_1_method0_Sig,2);
...
net1_WHS4_MC1_mean_Sig_star_method0_Sig = mean(Sig_star_method0_Sig,2);
net1_WHS4_MC1_mean_Sig_star_hat_method0_Sig(:,ob_i) = mean(Sig_star_hat_method0_Sig,2);
...
net1_WHS4_MC1_mean_Sig_star_method0_raw = mean(Sig_star_method0_raw,2);
net1_WHS4_MC1_mean_Sig_star_hat_method0_raw(:,ob_i) = mean(Sig_star_hat_method0_raw,2);

% method1_Sig
net1_WHS4_MC1_mean_ACC_1_method1_Sig = mean(ACC_1_method1_Sig,2);
net1_WHS4_MC1_mean_ACC_2_method1_Sig = mean(ACC_2_method1_Sig,2);
net1_WHS4_MC1_mean_rank_original_method1_Sig = mean(rank_original_method1_Sig,2);
net1_WHS4_MC1_mean_Sig_star_method1_Sig = mean(Sig_star_method1_Sig,2);
net1_WHS4_MC1_mean_Sig_star_hat_method1_Sig(:,ob_i) = mean(Sig_star_hat_method1_Sig,2);

% method1_raw
net1_WHS4_MC1_mean_ACC_1_method1_raw = mean(ACC_1_method1_raw,2);
net1_WHS4_MC1_mean_ACC_2_method1_raw = mean(ACC_2_method1_raw,2);
net1_WHS4_MC1_mean_rank_original_method1_raw = mean(rank_original_method1_raw,2);
net1_WHS4_MC1_mean_Sig_star_method1_raw = mean(Sig_star_method1_raw,2);
net1_WHS4_MC1_mean_Sig_star_hat_method1_raw(:,ob_i) = mean(Sig_star_hat_method1_raw,2);



hold on;
plot(ill_over_time_interval, MC11_mean_ACC_1_method0_Sig, 'b', 'marker','*')
plot(ill_over_time_interval, MC11_mean_ACC_1_method1_Sig, 'g','marker','*')
plot(ill_over_time_interval, MC11_mean_ACC_1_method0_raw, 'b','marker','o')
plot(ill_over_time_interval, MC11_mean_ACC_1_method1_raw, 'g','marker','o')

hold on;
plot(ill_over_time_interval, net1_WHS4_MC1_mean_ACC_1_method0_Sig, 'b', 'marker','*')
plot(ill_over_time_interval, net1_WHS4_MC1_mean_ACC_1_method1_Sig, 'g','marker','*')
plot(ill_over_time_interval, net1_WHS4_MC1_mean_ACC_1_method0_raw, 'b','marker','o')
plot(ill_over_time_interval, net1_WHS4_MC1_mean_ACC_1_method1_raw, 'g','marker','o')
