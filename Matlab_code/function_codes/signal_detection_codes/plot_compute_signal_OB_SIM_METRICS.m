function [net_SimSig_means, net_raw_means] = plot_compute_signal_OB_SIM_METRICS(all_food_nets, init_vals, stage_ends, current_ob_data, ill_over_time_interval, method_i, num_samples, dpr_flag)
