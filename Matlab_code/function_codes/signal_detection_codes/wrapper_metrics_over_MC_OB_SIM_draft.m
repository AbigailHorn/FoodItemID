...
% method0_Sig
mean_ACC_1_method0_Sig = mean(ACC_1_method0_Sig,2);
mean_ACC_2_method0_Sig = mean(ACC_2_method0_Sig,2);
mean_rank_original_method0_Sig = mean(rank_original_method0_Sig,2);
mean_Sig_star_method0_Sig = mean(Sig_star_method0_Sig,2);
mean_Sig_star_hat_method0_Sig(:,ob_i) = mean(Sig_star_hat_method0_Sig,2);

% method0_raw
mean_ACC_1_method0_raw = mean(ACC_1_method0_raw,2);
mean_ACC_2_method0_raw = mean(ACC_2_method0_raw,2);
mean_rank_original_method0_raw = mean(rank_original_method0_raw,2);
mean_Sig_star_method0_raw = mean(Sig_star_method0_raw,2);
mean_Sig_star_hat_method0_raw(:,ob_i) = mean(Sig_star_hat_method0_raw,2);

% method1_Sig
mean_ACC_1_method1_Sig = mean(ACC_1_method1_Sig,2);
mean_ACC_2_method1_Sig = mean(ACC_2_method1_Sig,2);
mean_rank_original_method1_Sig = mean(rank_original_method1_Sig,2);
mean_Sig_star_method1_Sig = mean(Sig_star_method1_Sig,2);
mean_Sig_star_hat_method1_Sig(:,ob_i) = mean(Sig_star_hat_method1_Sig,2);

% method1_raw
mean_ACC_1_method1_raw = mean(ACC_1_method1_raw,2);
mean_ACC_2_method1_raw = mean(ACC_2_method1_raw,2);
mean_rank_original_method1_raw = mean(rank_original_method1_raw,2);
mean_Sig_star_method1_raw = mean(Sig_star_method1_raw,2);
mean_Sig_star_hat_method1_raw(:,ob_i) = mean(Sig_star_hat_method1_raw,2);



hold on;
plot(ill_over_time_interval, mean_ACC_1_method0_Sig, 'b', 'marker','*')
plot(ill_over_time_interval, mean_ACC_1_method1_Sig, 'g','marker','*')
plot(ill_over_time_interval, mean_ACC_1_method0_raw, 'b','marker','o')
plot(ill_over_time_interval, mean_ACC_1_method1_raw, 'g','marker','o')
