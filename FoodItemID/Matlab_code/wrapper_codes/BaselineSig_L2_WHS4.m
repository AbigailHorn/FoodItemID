function [nested_ob_data, net_MC_means, net_MC_CI95] = BaselineSig_L2_WHS4(all_food_nets, all_net_names, init_vals, stage_ends, all_ob_data, all_ob_names, ill_over_time_interval, MC_method, num_samples, save_plot, sim_flag)
