---
title: "Simulated Signal Relative to Random: Stylized Networks"
author: "Abigail Horn"
date: "8/5/2021"
output: 
    html_document:
...
filenames <- c("ACC_raw_1_50", "ACC_raw_2_300", "ACC_raw_3_500","ACC_raw_4_300","ACC_raw_100samp_6_100") #c("ACC_SimSig_1_50", "ACC_SimSig_2_300", "ACC_SimSig_3_500")
...
acc_inputs[,"num_iter"] <- c(50,300,500,300,100) #c(30, 30, 30, 50, 30, 50, 150, 50, 50, 50, 20, 130, 50, 50, 50)
...
CI.out$foodnet = gsub("RLG", '', CI.out$foodnet)
CI.out <- dplyr::rename(CI.out, net_i=foodnet)
CI.out <- CI.out[,c(2,1,3:ncol(CI.out))]
CI.path <- path(output.dir, "accuracy/RLG6_CI_4Matlab.csv")
...
## Source supporting functions
convergence_readin <- path(code.dir, "get_convergence_RLG.R")
